...
function z_init() {
	...
	if (is_array($z_taxonomies)) {
		...
		if (empty($zci_options['excluded_taxonomies'])){
			if(isset($zci_options['excluded_taxonomies'])){
				$zci_options['excluded_taxonomies'] = array();
			}
			else{
				if(empty($zci_options)){
					$zci_options = array("excluded_taxonomies" => array());
				}
				else{
					$excluded_taxonomies = array("excluded_taxonomies" => array());
					$zci_options = array_merge_recursive($zci_options, $excluded_taxonomies);
				}
			}
