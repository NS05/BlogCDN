...
begin:/\b(print|exec)\(/}]}}}());hljs.registerLanguage("verilog",function(){"use strict";return function(e){
...
;return n.name="C",n.aliases=["c","h"],n}}());hljs.registerLanguage("vhdl",function(){"use strict";return function(e){return{
...
begin:"'[A-Za-z](_?[A-Za-z0-9])*",contains:[e.BACKSLASH_ESCAPE]}]}}}());hljs.registerLanguage("nginx",function(){"use strict";return function(e){var n={
